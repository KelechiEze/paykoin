...
const Login = () => {
  ...
  const handleGoHome = () => {
    window.location.href = 'https://paycoiyn.com';
  };

  return (
    <>
      {/* Back Home Button - No container */}
      <button
        onClick={handleGoHome}
        className="fixed top-4 left-4 z-50 flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-sm rounded-lg shadow-md hover:bg-white transition-colors border border-gray-200"
      >
        <ArrowLeft size={18} />
