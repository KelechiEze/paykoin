...
const findUserByWalletAddress = async (walletAddress: string, symbol: string) => {
  try {
    ...
    if (!querySnapshot.empty) {
      ...
      const userId = walletDoc.ref.parent.parent?.id;
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      batch.set(senderTxRef, {
        ...
        recipientAddress: recipientWalletAddress || recipientWalletData.walletAddress,
        transferMethod: transferMethod
      });
      
      // Update recipient's wallet balance (immediately for internal tracking)
      ...
      if (notificationSettings) {
        triggerNotifications(notificationSettings, {
          ...
          message: `Sent ${withdrawAmount} ${crypto.symbol} to ${transferMethod === 'email' ? recipientEmail : 'wallet address'}`
        }, toast);
      ...
      toast({
        ...
        description: `${withdrawAmount} ${crypto.symbol} sent. Recipient will receive it in 5 minutes.`,
      });
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex justify-between text-sm mb-2">
              ...
              <span className="text-amber-600">~5 minutes</span>
            </div>
