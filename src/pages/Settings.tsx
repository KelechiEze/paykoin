...
const Settings: React.FC = () => {
  ...
  const handleContactSupport = () => {
    window.location.href = 'mailto:kelechieze400@gmail.com?subject=Support%20Request&body=Hello%20Support%20Team,';
  };
        ...
        <div className="flex items-start">
          ...
          <div className="flex-1">
            ...
            <button
              ...
              className="mt-4 py-2 px-4 border border-gray-200 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors"
            >
              Contact Support
            </button>
          </div>
