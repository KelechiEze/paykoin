...
export const InteractiveStrategySection: React.FC<InteractiveStrategySectionProps> = ({
  ...
  return (
    <section className="bg-white text-zinc-900 py-16 lg:py-20 px-4 sm:px-6 lg:px-8 border-b border-zinc-200 select-none">
      <div className="max-w-7xl mx-auto">
        {/* Top Header & Intro text */}
        <div className="max-w-3xl mb-10 lg:mb-14">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-zinc-900 tracking-tight leading-[1.2] mb-4 font-sans">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="bg-[#61dafb] hover:bg-[#4faee3] text-slate-950 px-5 py-2.5 rounded-md font-semibold text-sm sm:text-base flex items-center gap-2 transition-all shadow-md shadow-[#61dafb]/20 transform hover:-translate-y-0.5 cursor-pointer"
            >
            ...
            <button
              onClick={onOpenConsultation}
              className="bg-white border border-zinc-800 hover:bg-zinc-50 text-zinc-900 px-6 py-2.5 rounded-md font-semibold text-sm sm:text-base transition-all cursor-pointer transform hover:-translate-y-0.5"
            >
              <span>Login Now</span>
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-1 pt-2">
            {STRATEGY_ITEMS.map((item) => {
              ...
              return (
                <div
                  ...
                  className={`border-b border-zinc-200/90 py-4 transition-all duration-300 cursor-pointer group ${
                ...
                >
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${
                      isActive
                        ? 'max-h-40 opacity-100 mt-2 pl-7'
                        : 'max-h-0 opacity-0 pl-7 pointer-events-none'
                    }`}
                  >
                    <p className="text-zinc-600 text-sm sm:text-sm leading-relaxed max-w-xl">
                      {item.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-6 sticky top-28">
            <div className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-2xl h-[350px] sm:h-[400px] lg:h-[450px] border border-zinc-100 bg-zinc-900">
              ...
              <div className="absolute bottom-4 right-4 left-4 sm:left-auto sm:max-w-xs bg-zinc-950/90 text-white p-3 sm:p-3.5 rounded-xl border border-zinc-800 shadow-2xl backdrop-blur-md flex items-center gap-3 transition-all duration-500 transform">
                <div className="w-8 h-8 rounded-lg bg-[#61dafb] flex items-center justify-center text-slate-950 shrink-0 shadow-md shadow-[#61dafb]/20">
                  <ChevronsRight className="w-4 h-4 stroke-[3]" />
                </div>
                <p className="text-[10px] sm:text-xs font-semibold text-white/95 leading-snug">
